...
function homeLanding(myData){
 ...
 //    lille ramme
    let lilleRamme = document.createElement('p');
    lilleRamme.classList.add('lilleRammeClass');
    homeLanding.appendChild(lilleRamme);
 //    klokkeslet
    let klokke  = document.createElement('p');
    klokke.classList.add('klokkeClass');
    lilleRamme.appendChild(klokke);
 //   lille temp
    let lilleTemp = document.createElement('p');
    lilleTemp.classList.add('lilleTempClass');
    lilleTemp.innerText = myData.temp;
    lilleRamme.appendChild(lilleTemp);
